    ...
    <div class="min-h-screen talos-page-gradient py-4">
        <v-container class="!max-w-[1400px] !py-10 !px-5 max-sm:!py-5 max-sm:!px-2.5">
            <div v-if="portfolio" class="flex flex-col gap-10">
                <div
                    class="bg-[rgb(28_45_65/0.85)] backdrop-blur-[10px] border border-[rgb(185_157_117/0.2)] rounded-3xl !px-8 !py-6 max-sm:!p-5">
                    <div class="mb-4">
                ...
                <v-row class="!-mx-2">
                    <v-col cols="12" md="4" class="!px-2 !pb-4 md:!pb-0">
                        <v-card
                            class="talos-glow-card !flex !items-center !gap-4 !p-6 max-sm:!p-5 !bg-black/25 backdrop-blur-[10px] border border-[rgb(185_157_117/0.12)] !rounded-[20px] transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(185_157_117/0.35)] hover:shadow-[0_10px_30px_rgb(185_157_117/0.12)]">
                            <div
                                class="w-14 h-14 max-sm:w-12 max-sm:h-12 rounded-2xl flex items-center justify-center bg-[rgb(34_197_94/0.15)] text-[#22c55e]">
                                <v-icon size="28">mdi-trending-up</v-icon>
                            </div>
                            <div class="flex flex-1 flex-col gap-1.5">
                                <span class="text-[rgb(255_252_239/0.55)] text-[13px] uppercase tracking-wide">Retorno
                                    Esperado</span>
                                <span class="text-[32px] max-sm:text-2xl font-bold"
                    ...
                    <v-col cols="12" md="4" class="!px-2 !pb-4 md:!pb-0">
                        <v-card
                            class="talos-glow-card !flex !items-center !gap-4 !p-6 max-sm:!p-5 !bg-black/25 backdrop-blur-[10px] border border-[rgb(185_157_117/0.12)] !rounded-[20px] transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(185_157_117/0.35)] hover:shadow-[0_10px_30px_rgb(185_157_117/0.12)]">
                            <div
                                class="w-14 h-14 max-sm:w-12 max-sm:h-12 rounded-2xl flex items-center justify-center bg-[rgb(245_158_11/0.15)] text-[#f59e0b]">
                                <v-icon size="28">mdi-chart-line</v-icon>
                            </div>
                            <div class="flex flex-1 flex-col gap-1.5">
                                <span
                                    class="text-[rgb(255_252_239/0.55)] text-[13px] uppercase tracking-wide">Risco</span>
                    ...
                    <v-col cols="12" md="4" class="!px-2 !pb-0">
                        <v-card
                            class="talos-glow-card !flex !items-center !gap-4 !p-6 max-sm:!p-5 !bg-black/25 backdrop-blur-[10px] border border-[rgb(185_157_117/0.12)] !rounded-[20px] transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(185_157_117/0.35)] hover:shadow-[0_10px_30px_rgb(185_157_117/0.12)]">
                            <div
                                class="w-14 h-14 max-sm:w-12 max-sm:h-12 rounded-2xl flex items-center justify-center bg-[rgb(59_130_246/0.15)] text-[#3b82f6]">
                                <v-icon size="28">mdi-puzzle</v-icon>
                            </div>
                            <div class="flex flex-1 flex-col gap-1.5">
                                <span
                                    class="text-[rgb(255_252_239/0.55)] text-[13px] uppercase tracking-wide">Ativos</span>
                ...
                <v-card
                    class="talos-glow-card talos-stocks-card !bg-black/25 backdrop-blur-[10px] border border-[rgb(185_157_117/0.12)] !rounded-[20px] overflow-hidden !mt-2">
                    ...
                    <v-table
                        class="talos-stocks-table max-sm:[&_th]:!p-3 max-sm:[&_td]:!p-3 max-sm:[&_th]:!text-[13px] max-sm:[&_td]:!text-[13px]">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Empresa</th>
                        ...
                        <tbody>
                            <tr v-for="item in portfolio.portfolioStocks" :key="item.id"
                                ...
                                <td>
                                    <span class="text-[#22c55e] font-semibold">{{ item.percentage?.toFixed(2) || '0.00'
                                        }}%</span>
                                </td>
                                <td>
                                    <span class="text-[#22c55e] font-semibold">{{ item.stock.dividendYield?.toFixed(2)
                                        || '0.00' }}%</span>
                                </td>
                                <td>
            ...
            <v-alert v-else type="error" variant="tonal"
                class="!bg-[rgb(239_68_68/0.1)] !border !border-[rgb(239_68_68/0.2)] !rounded-2xl text-white">
